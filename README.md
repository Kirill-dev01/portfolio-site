...
* **The Arcade Sector:** A built-in gaming center featuring a real-time, WebSocket-powered multiplayer tactical game connected to a dedicated asynchronous Python backend. This sector will receive continuous updates, with new game modules slated for future deployment.

## 📱 Mobile Support
* **Status: IN ACTIVE DEVELOPMENT.** * The system is currently undergoing an architectural upgrade to implement an adaptive, smartphone-native UI layout for mobile users. Desktop viewing is recommended for the optimal experience in the meantime.

## 🛠️ Tech Stack
* **Frontend:** React, Vite, HTML5, CSS3
* **Networking:** WebSockets (Native API)
* **Backend:** Python (Asynchronous Multiplayer Server)